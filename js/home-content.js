document.addEventListener('DOMContentLoaded', () => {
  ...
  const homeData = {
    ...
    articles: [
      ...
      { title: 'Panduan memilih produk herbal yang sesuai kebutuhan', excerpt: 'Pelajari cara menilai kualitas, keamanan, dan manfaat produk sebelum memutuskan.', category: 'Tips Kesehatan', date: '12 Jul 2026', readTime: '4 menit', image: 'img/blog/panduan-memilih-produk-herbal-berkualitas.png', href: '/artikel/panduan-memilih-produk-herbal.html' },
    ...
    products: [
      { name: 'Black Blue MMC', price: 'Rp 180.000', image: 'img/product/black-blue-mmc.jpg', label: 'Terlaris', rating: '4.9', href: '/produk/black-blue-mmc.html' },
      { name: 'Viagra MMC Blue', price: 'Rp 160.000', image: 'img/product/viagra-mmc-blue.jpg', label: 'Rekomendasi', rating: '4.8', href: '/produk/viagra-mmc-blue.html' },
      { name: 'Super Stud 007', price: 'Rp 145.000', image: 'img/product/super-stud-007.jpg', label: 'Baru', rating: '4.7', href: '/produk/super-stud-007.html' }
    ],
    benefits: [
