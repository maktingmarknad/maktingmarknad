document.addEventListener('DOMContentLoaded', () => {
  ...
  const homeData = {
    ...
    articles: [
      ...
      { title: 'Viagra China: Kenali Kandungan, Risiko, dan Cara Memeriksa Legalitas Produk', excerpt: 'Istilah “Viagra China” sering dipakai untuk produk vitalitas pria yang beredar online. Kenali perbedaan obat yang terdaftar, produk tanpa identitas jelas, serta risiko penggunaan tanpa pengawasan tenaga kesehatan.', category: 'Kesehatan Pria', date: '19 Jul 2026', readTime: '6 menit', image: 'img/blog/Viagra-China.png', href: 'artikel-viagra-china.html' },
